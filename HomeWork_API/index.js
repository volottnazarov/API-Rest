 ...
 * Для создания раскоментировать код с 14 по 32 строки,
 * и закоментировать весь код ниже.
 *  После создания необходимо вернуть все обратно.
 */
// const counterId = {
//     countID: 0
// };
...
//     }
// });
// const jsonPathPerson = path.join(__dirname, 'person.json');
// const person = [];
// fs.writeFile(jsonPathPerson, JSON.stringify(person), (err) => {
//     if (err) {
//         console.error(err);
//     } else {
//         console.log('The file was saved');
